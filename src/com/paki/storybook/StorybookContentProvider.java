...
public class StorybookContentProvider extends ContentProvider {
	 public static final Uri CONTENT_URI = 
		      Uri.parse("content://com.paki.storybook/items");
		  ...
		  public String getType(Uri uri) {
		    ...
		    switch (uriMatcher.match(uri)) {
		      case ALLROWS: return "vnd.android.cursor.dir/vnd.paki.items";
		      case SINGLE_ROW: return "vnd.android.cursor.item/vnd.paki.items";
