...
public class StoryBookStaticImport extends ListActivity{
	 ...
	 */
		...
		while (cursor.moveToNext()) {
			...
			// Now we must retrieve the contact_ID from People :)
			...
			Log.v(StorybookContentProvider.TAG_LOG, "sto salvando dalle chiamate:" + name);
	...
	// Method to get SMS/MMS from Device :)
		...
		/*
		 * Method to get name from Messages (we get a number)
		 * Helper Method :)
		 */
